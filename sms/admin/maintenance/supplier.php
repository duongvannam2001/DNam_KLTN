...
<script>
	$(document).ready(function(){
		...
		$('#create_new').click(function(){
			uni_modal("<i class='fa fa-plus'></i> Thêm nhà cung cấp mới","maintenance/manage_supplier.php","mid-large")
		})
		$('.edit_data').click(function(){
			uni_modal("<i class='fa fa-edit'></i> Sửa nhà cung cấp","maintenance/manage_supplier.php?id="+$(this).attr('data-id'),"mid-large")
		})
		$('.view_data').click(function(){
			uni_modal("<i class='fa fa-truck-loading'></i> Chi tiết nhà cung cấp","maintenance/view_supplier.php?id="+$(this).attr('data-id'),"")
		})
