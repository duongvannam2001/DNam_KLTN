<h1 class="">Chào mừng <?php echo $_settings->info('name') ?></h1>
<hr>
<div class="row">
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box bg-light shadow">
            ...
            <span class="info-box-text">Hồ sơ PO</span>
    ...
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box bg-light shadow">
            ...
            <div class="info-box-content">
            <span class="info-box-text">Nhận hồ sơ</span>
            <span class="info-box-number text-right">
                <?php 
    ...
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box bg-light shadow">
            ...
            <div class="info-box-content">
            <span class="info-box-text">Hồ sơ BO</span>
            <span class="info-box-number text-right">
                <?php 
    ...
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box bg-light shadow">
            ...
            <div class="info-box-content">
            <span class="info-box-text">Hoàn trả hồ sơ</span>
            <span class="info-box-number text-right">
                <?php 
    ...
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box bg-light shadow">
            ...
            <div class="info-box-content">
            <span class="info-box-text">Hồ sơ bán hàng</span>
            <span class="info-box-number text-right">
                <?php 
    ...
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box bg-light shadow">
            ...
            <div class="info-box-content">
            <span class="info-box-text">Các nhà cung cấp</span>
            <span class="info-box-number text-right">
                <?php 
    ...
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box bg-light shadow">
            ...
            <div class="info-box-content">
            <span class="info-box-text">Vật phẩm</span>
            <span class="info-box-number text-right">
                <?php 
