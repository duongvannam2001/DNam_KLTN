    ...
    <div id='transaction-printable-details' class='position-relative'>
        <div class="row">
            <fieldset class="w-100">
                <legend class="text-info">Thông tin</legend>
                <div class="col-12">
...
<div class="form-group">
    <div class="col-12">
        <div class="d-flex justify-content-end align-items-center">
            <button class="btn btn-light btn-flat" type="button" id="cancel" data-dismiss="modal">Đóng</button>
        </div>
    </div>
</div>
    ...
    $(function(){
        ...
        $('#print').click(function(){
            ...
            var _head = $('head').clone()
                _head.find('title').text("Chi tiết thanh toán - Xem in")
