...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title">Quay lại chi tiết đơn hàng - <?php echo $bo_code ?></h4>
    </div>
    <div class="card-body" id="print_out">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <label class="control-label text-info">Từ mã P.O</label>
                ...
                <div class="col-md-6">
                    <label class="control-label text-info">Mã B.O</label>
                    <div><?php echo isset($bo_code) ? $bo_code : '' ?></div>
                </div>
            </div>
            <h4 class="text-info">Đơn hàng</h4>
            <table class="table table-striped table-bordered" id="list">
                ...
                <tfoot>
                    <tr>
                        <th class="text-right py-1 px-2" colspan="4">Tổng phụ</th>
                        <th class="text-right py-1 px-2 sub-total"><?php echo number_format($total,2)  ?></th>
                    </tr>
                    <tr>
                        <th class="text-right py-1 px-2" colspan="4">Mã giảm giá <?php echo isset($discount_perc) ? $discount_perc : 0 ?>%</th>
                    ...
                    <tr>
                        <th class="text-right py-1 px-2" colspan="4">Tổng</th>
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-dark" href="<?php echo base_url.'/admin?page=back_order' ?>">Trở lại danh mục</a>
    </div>
</div>
